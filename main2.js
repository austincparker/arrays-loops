...
// const vacation = (place) => {
//     return `we're going on vacation to ${place}.`;
// }

// const work = (place) => {
//     return `we're going to work at ${place}.`;
// }

// const travel = (place, cb) => {
//    return cb(place);
// }

// console.log(travel('the beach', work));

const mainBtn2 = document.querySelector('#main-btn2')
